...
public class SommeDeTableauDiff {
	...
	/*
	 * retourne un tableau contenant les somme des données des tableaux passé en
	 * paramètres
	 */
	...
	/*
	 * retourne un tableau contenant les somme des données des tableaux passé en
	 * paramètres le tableau passé en premier paramètre seras écrasé par l'opération
	 * 
	 * l'opération retourne le premier paramètre intact si le second tableau est
	 * plus grand que premier.
	 */
