...
public class SommeDeTableaux {
	 ...
	 * paramètres les tableaux doivent avoir la même taille
	 */
	...
	public static void display3Array(int[] array, int[] array2, int[] array3) {
		...
		if (array.length == array2.length && array.length == array3.length) {
			...
			for (int i = 0; i < array.length; i++) {
				...
				// mise en forme
				System.out.println("index" + indexSpace + i + " :" + array1Space + array[i] + "|" + array2Space
						+ array2[i] + " |" + array3Space + array3[i]);
			}
			System.out.println("\n fin du tableau \n");
		}
	}
