...
public class InversionContenu {
	...
	/**
	 * CRéer une copy inversée du tableau passé en premier paramètre dans le tableau passé en second
	 * les deux tableau doivent avoir la même taille
	 * @param array
	 * @param arrayCopy
	 */
	...
	/*
	 * affiche les deux tableau côte à côte dans la console pour comparaison
